...
const EditKeunggulan = () => {
  ...
  const updateKeunggulan = async (e) => {
    e.preventDefault();
  ...
  const getKeunggulanById = async () => {
    const response = await axios.get(`http://localhost:8000/keunggulan/${id}`);
  ...
  return (
    <div className="columns mt-5 is-centered">
      <div className="column is-half">
        <form onSubmit={updateKeunggulan}>
          <div className="field">
